...
from .configs import robots as robot_configs, scenes as scene_configs, algorithms as alg_configs
...
def get_configs(args) -> Tuple[robot_configs.GO2DefaultCfg, scene_configs.BaseSceneCfg, alg_configs.PPODefaultCfg]:
    robots = {
