...
def get_args():
    custom_parameters = [
        {"name": "model_path", "type": str, "help": "Path to model/policy checkpoint"},
        {
            "name": "--num_envs",
            "type": int,
...
def play(task_name, args):
    ...
    ppo_runner.load(args.model_path)
